...
class AuxiliaryFunctions:
    ...
    def create_file_for_kp_instance_data_varying_size(kp_instance: KnapsackProblem):
        return open(
            f"C:\\Users\\d92474\\Documents\\Uni\\Master Thesis\\GitHub\\MasterThesis_Hybrid-Quantum-Classical-Branch-and-Bound\\kp_instances_data\\approximation_ratios\\varying_size\\{kp_instance.number_items}.txt", 
            "a"
        )
    
    def create_file_for_kp_instance_data_varying_max_value(kp_instance: KnapsackProblem):
        return open(
            f"C:\\Users\\d92474\\Documents\\Uni\\Master Thesis\\GitHub\\MasterThesis_Hybrid-Quantum-Classical-Branch-and-Bound\\kp_instances_data\\approximation_ratios\\varying_max_value\\{kp_instance.number_items}.txt", 
            "a"
        )
