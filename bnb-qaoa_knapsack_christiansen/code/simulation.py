...
def simulate_number_of_explored_nodes_in_bnb_for_kp_instance_size(bnb_repitions: int, number_of_capacities_per_instance: int):
    ...
    for capacity_idx in range(1, number_of_capacities_per_instance + 1):
        ...
        for number_of_items in numbers_of_items:
            ...
            kp_instance = KnapsackProblem(profits, weights, capacity = capacity_idx / (number_of_capacities_per_instance + 1) * sum(weights))
...
def main():
    ...
    simulate_number_of_explored_nodes_in_bnb_for_kp_instance_size(bnb_repitions = 5, number_of_capacities_per_instance = 4)
